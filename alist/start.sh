...
get_latest_version() {
    ...
    RELEASE_LATEST="$(curl -IkLs -o ${TMP_DIRECTORY}/NUL -w %{url_effective} https://github.com/OpenListTeam/OpenList/releases/latest | grep -o "[^/]*$")"
...
download_web() {
    DOWNLOAD_LINK="https://github.com/OpenListTeam/OpenList/releases/latest/download/openlist-freebsd-amd64.tar.gz"
